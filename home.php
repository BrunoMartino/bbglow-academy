...
get_header(); ?>
<?php 
$image_url = get_template_directory_uri() . '/assets/img-refact';
...
<div class="sess1_video-wrapper">
  <video class="sess1_video" src="<?= the_field('sess1_bg_video') ?>"  type="video/mp4" autoplay loop muted>
  </video>
  <div class="sess1_cta container-zion" data-anima="scroll">
...
<section id="sess2" class="container-zion">
<div class="sess2_description" data-anima="scroll">
  <h2 class="font-1-xl"><?= the_field('sess2_title') ?></h2>
  <p class="font-2-s"><?= the_field('sess2_subtitle') ?></p>
</div>
<div class='sess2_showcase'>
  <div class='sess2_showcase-wrapper' data-anima="scroll">
    <img src="<?= the_field('sess2_showcase_1') ?>" alt="">
    <div>
      <p class="font-1-up-s"><?= the_field('sess2_showcase_1_name') ?></p>
      <p class="font-1-up-s"><?= the_field('sess2_showcase_1_description') ?></p>
    </div>
  </div>
  <div class='sess2_showcase-wrapper' data-anima="scroll">
    <img src="<?= the_field('sess2_showcase_2') ?>" alt="">
    <div>
      <p class="font-1-up-s"><?= the_field('sess2_showcase_2_name') ?></p>
      <p class="font-1-up-s"><?= the_field('sess2_showcase_2_description') ?></p>
    </div>
  </div>
  <div class='sess2_showcase-wrapper' data-anima="scroll">
    <img src="<?= the_field('sess2_showcase_3') ?>" alt="">
    <div>
      <p class="font-1-up-s"><?= the_field('sess2_showcase_3_name') ?></p>
      <p class="font-1-up-s"><?= the_field('sess2_showcase_3_description') ?></p>
    </div>
</div>
</section>
...
<section id="sess3" class="container-zion product-gallery"> 
<div class="product-title">
  <h2 class="font-1-xl"><?= the_field('sess3_title') ?></h2>
  <a class="font-1-up-s" href="<?= the_field('sess3_btn_link') ?>"><?= the_field('sess3_btn_label') ?></a>
</div>
<div>
...
<div class="sess4_wrapper">
  <div class='sess4_content container-zion' data-anima="scroll">
    <h2 class="font-1-xl"><?=the_field('sess4_title'); ?></h2>
    <p class="font-2-s"><?=the_field('sess4_subtitle'); ?></p>
    <a class="shop_btn" href="<?=the_field('sess4_btn_link'); ?>"><?=the_field('sess4_btn_label'); ?></a>
  </div>
</div>
</section>
<section id="sess5" class="container-zion">
...
<div class="sess5_content-wrapper" data-anima="scroll">
  <div class="sess5_content-description">
    <h3 class='font-1-xl'><?= the_field("sess5_title") ?></h3>
    <p class="font-2-s"><?= the_field("sess5_text") ?></p> 
  </div>
  <div class="sess5_adv-wrapper">
    <div class="sess5_adv">
      <img src="<?= $image_url . '/bag.svg' ?>" alt="">
      <div>
      <h4 class="font-2-m">Trusted Seller</h4>
      <p class="font-2-xs">Trusted seller for quality beauty products.</p>
      </div>
    </div>
    <div class="sess5_adv">
      <img src="<?= $image_url . '/shield.svg' ?>" alt="">
      <div>
      <h4 class="font-2-m">100% Secure</h4>
      <p class="font-2-xs">Purchasing from us is 100% secure for your peace of mind.</p>
      </div>
    </div>
  </div>
</div>
</section>
<section id="sess6" class="sess6 container-zion product-gallery"> 
<div class="product-title">
...
<div class="sess7_wrapper">
  ...
  <h4 class="font-1-m">Customer Support</h4>
  <p class="font-2-xs">Experience unparalleled customer support tailored to your needs.</p>
  <a class="shop_btn" href="tel:+16179555006">Call Us</a>
  </div>
  <div class='sess7_contact-box' data-anima="scroll">
  <img src="<?= $image_url . '/mail.svg' ?>" alt="icon">
  <h4 class="font-1-m">Live Chat with our Team</h4>
  <p class="font-2-xs">Need assistance? Our chat support is here to help you in real-time.</p>
  <a class="shop_btn" id="chat_link" href="/chat">Click on chat icon</a>
  </div>
  <div class='sess7_contact-box' data-anima="scroll">
  <img src="<?= $image_url . '/file.svg' ?>" alt="icon">
  <h4 class="font-1-m">Blog & Tutorials</h4>
  <p class="font-2-xs">Explore our insightful blogs for the latest trends and expert beauty advice.</p>
...
<section id="sess8" class="container-zion">
